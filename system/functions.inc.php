 ...
 */
function get_major_pic_url($size = null, $pic_file = null)
{
	// if ($sized_file = AWS_APP::model('major')->get_sized_file($size, $pic_file))
	// {
		// return get_setting('upload_url') . '/major/' . $sized_file;
	// }
// 	
	// if (! $size)
	// {
		return G_STATIC_URL . '/common/topic-mid-img.png';
	// }
// 	
	// return G_STATIC_URL . '/common/major-' . $size . '-img.png';
}
/**
 * 获取主题图片指定尺寸的完整url地址
 * @param  string $size
